...
parser.add_argument('--efficiencycut',  type=int, help='which efficiencycut you choose.',choices=[-1, 0])
...
Efficiencycut = arguments.efficiencycut
...
for Efficiency in Efficiencyall:
    ...
    for Energybin in ["38.9_41.9","41.9_45.1","45.1_48.5","48.5_52.2","52.2_56.1","56.1_60.3","60.3_64.8","64.8_69.7","69.7_74.9","74.9_80.5","80.5_93.0","93.0_108.0","108.0_125.0","125.0_147.0","147_175", "175_211", "211_259", "259_330", "330_525",]:
            ...
            if Testsample == "electron":
                if Energybin == "211_259" or Energybin == "259_330" or Energybin == "330_525":
                    testset1 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.2002000_7.6_all/'+'147-1000GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.2002000_7.6_all/'+'147-1000GeV_v2'+'/transferdata/positive/'+Energybin+'GeV/pattern0/positive_'+Energybin+'_pattern_0.npy',encoding="latin1")
                elif Energybin == "175_211":
                    testset1_below = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.0_25200_7.6_all/'+'147-1000GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2_below = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.0_25200_7.6_all/'+'147-1000GeV_v2'+'/transferdata/positive/'+Energybin+'GeV/pattern0/positive_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset1_above = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.2002000_7.6_all/'+'147-1000GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2_above = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.2002000_7.6_all/'+'147-1000GeV_v2'+'/transferdata/positive/'+Energybin+'GeV/pattern0/positive_'+Energybin+'_pattern_0.npy',encoding="latin1")
                ...
                elif Energybin == "147_175":
                    testset1 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.0_25200_7.6_all/'+'147-1000GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.0_25200_7.6_all/'+'147-1000GeV_v2'+'/transferdata/positive/'+Energybin+'GeV/pattern0/positive_'+Energybin+'_pattern_0.npy',encoding="latin1")
                else:
                    testset1 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.0_25200_7.6_all/'+'38.9-147GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1091_el.pl1.0_25200_7.6_all/'+'38.9-147GeV_v2'+'/transferdata/positive/'+Energybin+'GeV/pattern0/positive_'+Energybin+'_pattern_0.npy',encoding="latin1")
    ...
    #            print('testset2'+str(testset2.shape))
                ...
                if Energybin == "147_175" or Energybin == "175_211" or Energybin == "211_259" or Energybin == "259_330" or Energybin == "330_525": 
                    testset1 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1042_pr.pl1.flux.l1o9.2016000_7.6_all/'+'147-1000GeV_v2'+'/transferdata/positive/'+Energybin+'GeV/pattern0/positive_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1042_pr.pl1.flux.l1o9.2016000_7.6_all/'+'147-1000GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2 = np.row_stack((testset2,np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1042_pr.pl1.flux.l1a9.2016000_7.6_all/'+'147-1000GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")))
                else:
                    testset1 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1042_pr.pl1.flux.l1o9.2016000_7.6_all/'+'38.9-147GeV_v2'+'/transferdata/positive/'+Energybin+'GeV/pattern0/positive_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2 = np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1042_pr.pl1.flux.l1o9.2016000_7.6_all/'+'38.9-147GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")
                    testset2 = np.row_stack((testset2,np.load('/hpcwork/jara0052/sichen/analysis_7.0/B1042_pr.pl1.flux.l1a9.2016000_7.6_all/'+'38.9-147GeV_v2'+'/transferdata/negative/'+Energybin+'GeV/pattern0/negative_'+Energybin+'_pattern_0.npy',encoding="latin1")))
                testset1 = testset1[-testset2.shape[0]:,:]
                if (EcalBDTCut):
                ...
                if (TrdProtonHeliumCut):
                    testset1 = testset1[np.where(testset1[:,TrdLogLikelihoodRatioProtonHeliumTracker] < TrdProtonHeliumCutValue)[0],:]
                    testset2 = testset2[np.where(testset2[:,TrdLogLikelihoodRatioProtonHeliumTracker] < TrdProtonHeliumCutValue)[0],:]                 
                testset1 = testset1[np.where(testset1[:,MvAresult] > -2.0)[0],:]
                testset2 = testset2[np.where(testset2[:,MvAresult] > -2.0)[0],:]
            else:
            ...
            if Energybin == "80.5_93.0" or Energybin == "93.0_108.0" or Energybin == "108.0_125.0" or Energybin == "125.0_147.0" or Energybin == "147_175" or Energybin == "175_211" or Energybin == "211_259" or Energybin == "259_330" or Energybin == "330_525":
                model.load_weights('~/v7.0_05.03.2019/VGG16_v7.0/VGG16_v7_mva_only_yescccut_yesecalcut_yestrd_v3.5_withmvaonly_ele_posi_same_2electronMCused_protonfromTF_trdccbinTuned/pattern_0/weight/VGG16_'+Energybin+'_mva_variables'+'.h5')
            else:
                model.load_weights('~/v7.0_05.03.2019/VGG16_v7.0/VGG16_v7_mva_only_yescccut_yesecalcut_yestrd_v3.5_withmvaonly_ele_posi_same_2electronMCused_protonfromTF_trdccbinTuned/pattern_0/weight/VGG16_'+'38.9_80.5'+'_mva_variables'+'.h5')
   ...
   #            print(minvalue)
            ...
            NN_rejection = np.append(NN_rejection,rejectionCCprotonset[index_NN[Efficiencycut,0]])
            if Testsample == "electron" or Testsample == "B1119_ele":
                MVA_rejection = np.append(MVA_rejection,rejectionCCelectronsetMvA[index_MVA[Efficiencycut,0]])
            elif Testsample == "proton":
                MVA_rejection = np.append(MVA_rejection,rejectionCCprotonsetMvA[index_MVA[Efficiencycut,0]])  

            print(NN_rejection)
            print(NN_rejection_all_eff.shape)
...
print(NN_rejection_all_eff)
print(MVA_rejection_all_eff)
print(NN_rejection_all_eff.shape)
print(MVA_rejection_all_eff.shape)
'''                
print(NN_rejection_all_eff.shape)
print(NN_rejection_all_eff)
#print(a.shape)
...
if Testsample == "electron" or Testsample == "B1119_ele":
    plt.savefig('/home/bo791269/v7.0_05.03.2019/VGG16_v7.0/VGG16_v7_mva_only_yescccut_yesecalcut_yestrd_v3.5_withmvaonly_ele_posi_same_2electronMCused_protonfromTF_trdccbinTuned/pattern_0/ISS_anylsis/plot/Electron_Compare.png')
elif Testsample == "proton":
    plt.savefig('/home/bo791269/v7.0_05.03.2019/VGG16_v7.0/VGG16_v7_mva_only_yescccut_yesecalcut_yestrd_v3.5_withmvaonly_ele_posi_same_2electronMCused_protonfromTF_trdccbinTuned/pattern_0/ISS_anylsis/plot/Proton_Compare.png')
