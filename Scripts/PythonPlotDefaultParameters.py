...
plt.rcParams['mathtext.fontset'] = 'stix'  #["dejavusans", "dejavuserif", "cm", "stixsans", "stix"]
plt.rcParams['mathtext.rm'] = 'sans\-serif'        # mathtext.rm==\mathrm{} Roman (upright)
plt.rcParams['mathtext.it'] = 'sans\-serif:italic' # mathtext.it==\mathit{} or default italic
