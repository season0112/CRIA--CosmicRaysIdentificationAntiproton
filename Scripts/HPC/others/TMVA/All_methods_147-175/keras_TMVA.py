...
positivefile_ele = TFile.Open("positive_ele.root")
negativefile_ele = TFile.Open("negative_ele.root")
# Get signal and background trees from file
background1 = negativefile.Get('tree')
background2 = positivefile_ele.Get('tree')
signal1 = positivefile_test.Get('tree')
signal2 = negativefile_ele.Get('tree')

signal1.SetEntries(background1.GetEntries())
signal2.SetEntries(background1.GetEntries())
...
canvas.Draw()
#canvas.Print("result_all_method.png")
canvas.Print("result_bdt.png")
