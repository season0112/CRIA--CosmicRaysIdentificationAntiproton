...
reader.BookMVA("BDTG","dataset_pymva/weights/TMVAClassification_BDTG.weights.xml")
########################################################################################
...
mva_BDTG_signal_array = np.array([])
mva_BDTG_background_array = np.array([])
...
for ievt in range(signal_array.shape[0]):
	...
	mva_BDTG = reader.EvaluateMVA("BDTG")
	mva_BDTG_signal_array = np.append(mva_BDTG_signal_array,mva_BDTG)      
#	print("ievt="+str(ievt))
#	print("mva_BDTG="+str(mva_BDTG))
np.save("application_results/mva_BDTG_signal_array.npy", mva_BDTG_signal_array)
...
for ievt in range(background_array.shape[0]):
        ...
        mva_BDTG = reader.EvaluateMVA("BDTG")
        mva_BDTG_background_array = np.append(mva_BDTG_background_array,mva_BDTG)
#        print("ievt="+str(ievt))
#        print("mva_BDTG="+str(mva_BDTG))
np.save("application_results/mva_BDTG_background_array.npy", mva_BDTG_background_array)
