...
np.save("application_results/mva_LikelihoodKDE_signal_array.npy", mva_LikelihoodKDE_signal_array)
...
for ievt in range(background_array.shape[0]):
        ...
        print("ievt="+str(ievt))
        print("mva_LikelihoodKDE="+str(mva_LikelihoodKDE))
np.save("application_results/mva_LikelihoodKDE_background_array.npy", mva_LikelihoodKDE_background_array)
