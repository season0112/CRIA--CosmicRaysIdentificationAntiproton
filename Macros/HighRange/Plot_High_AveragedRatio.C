...
// Load High range
TFile *HighFile2016 = new TFile( (string(getenv("HPCHIGHENERGYDATADIR")) + string("/ISS_anylsis/unfolding/published2016/450version/unfolded_results_May2015.root")).c_str() ) ;
TGraphErrors *g_HighResult_2016 = (TGraphErrors*)HighFile2016->Get("My_ratio");
TGraph *g_chi2dof_high_2016 = (TGraphErrors*)HighFile2016->Get("g_fitchi2");
HighFile2016->Close();

TFile *HighFilepass78 = new TFile( (string(getenv("HPCHIGHENERGYDATADIR")) + string("/ISS_anylsis/unfolding/pass7.8/525version/unfolded_results.root")).c_str() ) ;
TGraph *g_chi2dof_high_pass78 = (TGraphErrors*)HighFilepass78->Get("g_fitchi2");
TGraphErrors *g_HighResult_pass78 = (TGraphErrors*)HighFilepass78->Get("My_ratio");
TGraphErrors *g_publisehd_ratio = (TGraphErrors*)HighFilepass78->Get("publisehd_ratio");
HighFilepass78->Close();
...
g_HighResult_pass78->Draw("same P");
...
legend1->AddEntry(g_HighResult_pass78,"HighRange","lpf");
...
g_chi2dof_high_pass78->Draw("AP");

g_chi2dof_high_pass78->SetMarkerStyle(15);
g_chi2dof_high_pass78->SetMarkerColor(1);
TAxis * xaxis_chi2_pass78 = g_chi2dof_high_pass78->GetXaxis();
TAxis * yaxis_chi2_pass78 = g_chi2dof_high_pass78->GetYaxis();
xaxis_chi2_pass78->SetTitle("Rigidity (GV)");
yaxis_chi2_pass78->SetTitle("Chi2/dof");
xaxis_chi2_pass78->SetTitleFont(62);
yaxis_chi2_pass78->SetTitleFont(62);
xaxis_chi2_pass78->SetTitleSize(0.06);
yaxis_chi2_pass78->SetTitleSize(0.06);
xaxis_chi2_pass78->SetLabelFont(62);
yaxis_chi2_pass78->SetLabelFont(62);
xaxis_chi2_pass78->SetLabelSize(0.05);
yaxis_chi2_pass78->SetLabelSize(0.05);

c_chi2.SaveAs("chi2_pass78.pdf");
