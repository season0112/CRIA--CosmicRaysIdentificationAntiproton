...
#define INFO_OUT_TAG "AntiprotonLowEnergy"
...
int main(int argc, char** argv) {
  ...
  config.SetProgramHelpText("AntiprotonLowEnergy",
  ...
  auxiliaryObjectManager.SetPrefix("AntiprotonLowEnergy_Auxiliary");
  ...
  IO::TreeWriter treeWriter(new AntiprotonLowEnergyTree, IO::TreeOptions::DontWriteInMemoryBranches);
  std::string treeFileName = Utilities::ObjectManager::MakeStandardRootFileName(resultDirectory, "AntiprotonLowEnergy_Tree", suffix);
