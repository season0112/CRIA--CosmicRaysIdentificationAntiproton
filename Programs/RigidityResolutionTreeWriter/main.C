...
#define INFO_OUT_TAG "RigidityResolutionTreeWriter"
...
int main(int argc, char** argv) {
  ...
  config.SetProgramHelpText("RigidityResolutionTreeWriter",
  ...
  std::string cutConfigfile = "${MY_ANALYSIS}/Configuration/RigidityResolution.cfg";
  ...
  IO::TreeWriter treeWriter(new RigidityResolutionTree, IO::TreeOptions::DontWriteInMemoryBranches);
