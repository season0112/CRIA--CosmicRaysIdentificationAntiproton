#ifndef RigidityResolutionTree_hh
#define RigidityResolutionTree_hh

#include "TreeInterface.hh"

#define TRACK_FIT_PATTERNS 8
...
class RigidityResolutionTree : public IO::TreeInterface {
public:
  RigidityResolutionTree();
...
// MVA
  ...
  IO::TreeBranch<Float_t> InnerMaxSpanRigidityMatchingv2       { "InnerMaxSpanRigidityMatchingv2",             0.0f,  };
  IO::TreeBranch<Float_t> L1L9RigidityMatching                 { "L1L9RigidityMatching",             0.0f,  };
  IO::TreeBranch<Float_t> L1L9RigidityMatchingv2               { "L1L9RigidityMatchingv2",             0.0f,  };

  IO::TreeBranch<Float_t> L24L58RigidityMatching               { "L24L58RigidityMatching",             0.0f,  };
  IO::TreeBranch<Float_t> L24L58RigidityMatchingv2             { "L24L58RigidityMatchingv2",             0.0f,  };
...
*/
  IO::TreeBranch<std::vector<Float_t>> XLayer        { "XLayer"              ,  IO::TreeVectorSize(9) };
  IO::TreeBranch<std::vector<Float_t>> YLayer        { "YLayer"              ,  IO::TreeVectorSize(9) };

// Robin's Rigidity
  IO::TreeBranch<std::vector<float>> RigidityValue { "RigidityValue", IO::TreeVectorSize(TRACK_FIT_Algorithm) };
  IO::TreeBranch<std::vector<float>> RigidityInverseError { "RigidityInverseError", IO::TreeVectorSize(TRACK_FIT_Algorithm) };
  IO::TreeBranch<std::vector<float>> RigidityChi2X { "RigidityChi2X", IO::TreeVectorSize(TRACK_FIT_Algorithm) };
  IO::TreeBranch<std::vector<float>> RigidityChi2Y { "RigidityChi2Y", IO::TreeVectorSize(TRACK_FIT_Algorithm) };
  IO::TreeBranch<std::vector<float>> RigidityResidualYL1 { "RigidityResidualYL1", IO::TreeVectorSize(TRACK_FIT_Algorithm) };
  IO::TreeBranch<std::vector<float>> RigidityResidualYL9 { "RigidityResidualYL9", IO::TreeVectorSize(TRACK_FIT_Algorithm) };


private:
  virtual void Fill(const Analysis::Event&);
  virtual void UpdateInMemoryBranches();
  virtual IO::TreeInterface* Create() const { return new RigidityResolutionTree; }
