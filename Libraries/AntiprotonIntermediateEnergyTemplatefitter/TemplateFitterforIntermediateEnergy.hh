#ifndef TemplateFitterforIntermediateEnergy_hh
#define TemplateFitterforIntermediateEnergy_hh
...
public:
  ...
  TCanvas* CreateResultDrawing_LogY(std::string canvasname, int width, int height, double fitrange, bool defaultStyle = true) const;
